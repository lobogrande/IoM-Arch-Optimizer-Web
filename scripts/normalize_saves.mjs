...
//
// Import logic mirrors  loadStateFromJson()  in src/store.js
...
// Default store state (subset relevant to import/export), from src/store.js
...
// --- IMPORT: faithful port of loadStateFromJson(data) from src/store.js ---
function loadStateFromJson(state, data) {
