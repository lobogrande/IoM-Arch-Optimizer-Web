  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="w-full md:w-1/4 flex flex-col gap-4">
        ...
        <div data-tour="setup-import" className="st-container">
          <h3 className="font-bold mb-4 flex items-center gap-2">📂 Import Data</h3>
          <p className="text-sm text-st-text-light mb-4">
            <span className="font-bold text-st-orange">⚠️ Note:</span> Do not use the in-game JSON export! This importer strictly requires save files generated by the <strong>Export Data</strong> button below.
          </p>
        ...
        <div data-tour="setup-export" className="st-container">
      ...
      <div className="w-full md:w-3/4">
        ...
        {activeSubTab === 'upgrades_ext' && (
          <div id="tour-setup-ext-upgrades">
